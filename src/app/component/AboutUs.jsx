      ...
      <div className="max-w-7xl mx-auto space-y-8 sm:space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
            className="lg:col-span-2 bg-slate-900/60 border border-slate-800 rounded-2xl p-6 sm:p-8 space-y-4 shadow-xl backdrop-blur-sm"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            ...
            <motion.div
              ...
              className="bg-slate-900/60 border border-slate-800 rounded-2xl p-5 hover:border-purple-500/50 transition-all group shadow-xl"
            >
