...
export default function NoticesPage() {
  ...
  return (
    <div className="bg-slate-950 text-white pt-6 sm:pt-10 pb-12 px-3 sm:px-6 lg:px-8">
        ...
        {notices.length > 0 ? (
          <div className="space-y-4">
            {notices.map((notice, index) => (
              <div
                key={index}
                className="bg-slate-900/60 border border-slate-800 p-3 sm:p-4 rounded-xl space-y-1.5 hover:border-purple-500/50 transition-all"
              >
          ...
          <div className="text-center py-10 sm:py-16 px-4 bg-slate-900/40 rounded-xl border border-slate-800/80 space-y-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-500/10 text-purple-400 rounded-full flex items-center justify-center mx-auto border border-purple-500/20">
              <AlertCircle size={22} />
            </div>
            <div className="space-y-1">
              <h3 className="text-base sm:text-lg font-bold text-white">কোনো নোটিশ নেই</h3>
